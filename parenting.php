...
<html lang="en">
  <head>
    ...
    <title>Parenting | Baby Care</title>
  </head>
  <body>
   ...
   <div class="row mt-5 no-gutters">
    ...
    <div class="col-md-10">
<br>
      <h4 class="text-center font-weight-bold mr-6 mt-4 mb-4">PARENTING</h4>

      <div class="row mx-auto">
        <?php 
    $ambil=$koneksi->query("SELECT * FROM jenis_jasa_produk WHERE id_kategori=3");
    ?>
