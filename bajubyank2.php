...
<html lang="en">
  <head>
    ...
    <title>Pakaian Anak Perempuan | Baby Care</title>
  </head>
  <body>
  ...
  <div class="row mt-5 no-gutters">
    ...
    <div class="col-md-10">
<br>
      <h4 class="text-center font-weight-bold mr-6 mt-4 mb-4">PAKAIAN ANAK PEREMPUAN</h4>

      <div class="row mx-auto">
       <?php 
    $ambil=$koneksi->query("SELECT * FROM produk WHERE id_kategori=11");
    ?>
