...
<html lang="en">
  <head>
    ...
    <title>Pregnancy | Baby Care</title>
  </head>
  <body>
 ...
 <div class="row mt-5 no-gutters">
    ...
    <div class="col-md-10">
      ...
      <h4 class="text-center font-weight-bold mr-6 mt-4 mb-4">PREGNANCY</h4>

      <div class="row mx-auto">
        <?php 
    $ambil=$koneksi->query("SELECT * FROM jenis_jasa_produk WHERE id_kategori=1");
    ?>
    <?php while ($perproduk = $ambil->fetch_assoc()) { ?>
        <div class="card mr-2 ml-2" style="width: 16rem;">
          ...
          <?php } ?>
       <?php 
    $ambil=$koneksi->query("SELECT * FROM produk WHERE id_kategori=1");
    ?>
    <?php while ($perproduk = $ambil->fetch_assoc()) { ?>
        <div class="card mr-2 ml-2" style="width: 16rem;">
